...
ipcMain.handle('add-hearing', (event, hearing) => {
  ...
  const now = new Date().toISOString();
  return runInsert(`INSERT INTO hearings (hearing_id, matter_id, hearing_date, hearing_time, 
...
ipcMain.handle('add-judgment', (event, judgment) => {
  ...
  const now = new Date().toISOString();
  return runInsert(`INSERT INTO judgments (judgment_id, matter_id, hearing_id, judgment_type, 
